...
def main():
    ...
    flash_result, flash_time = benchmark(flash_attn.fa_forward, q, k, v, name="Flash Attention")
...
#     v_id = torch.eye(4, device="cuda").view(1,1,4,4)
    ...
    # Flash attention
    # flash_result = flash_attn.fa_forward(q_id, k_id, v_id)
